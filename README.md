...
- sessions are used with cookies so if the server for some reason resets that session is still valid

1. What does bcrypt do to help us store passwords in a secure manner.

- bcrypt helps us encrypt the password so any hackers trying to steal passwords wont get the original one

1. What does bcrypt do to slow down attackers?

- it makes it a very long string that the longer your password is the longer the bcrypt string is.

1. What are the three parts of the JSON Web Token?

- the three parts is the header, payload and the signature.
